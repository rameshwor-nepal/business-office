    ...
    return (
        <>
            <footer className="bg-blue-2">
                <section className="mx-auto w-full max-w-screen-xl py-16 lg:py-20">
                    <div className="md:flex md:gap-20">
                        <div className="mb-6 md:mb-0 bg-white p-6 w-[23.5rem] h-[12rem] flex flex-col gap-4">
                            <span className="text-3xl text-blue-2 font-medium">Business Logo</span>
                ...
                <section className='h-26 px-32 bg-blue-1 flex justify-between items-center'>
