...
const Testimonials = () => {
    return (
        <section className="px-32 py-16 h-fit relative w-fit bg-[linear-gradient(to_top,rgba(255,255,255,1),rgba(255,255,255,0.8),rgba(255,255,255,0.8)),url('/p5.jpg')]" style={{ backgroundSize: 'cover' }}>
            <div className='flex items-center gap-16 justify-between'>
                <div className=''>
                    ...
                    <h1 className='text-7xl text-blue-2 font-extrabold leading-extra-tight my-3'>
                ...
                <div className=" bg-[linear-gradient(to_top,rgba(22,33,84,0.8),rgba(55,92,157,0.9)),url('/p7.jpg')] w-full h-[28rem]" style={{ backgroundSize: "cover" }}>
                    <div className=' h-full relative flex flex-col justify-between'>
                        <div className='border-l-[10px] border-solid border-cyan-1 px-12 flex flex-col'>
                            <div className='text-gray-2 ml-[92%] text-7xl px-2 pt-2  '>
                                <FaQuoteLeft />
                            </div>
