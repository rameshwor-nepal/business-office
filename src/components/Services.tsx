...
const Services = () => {
    return (
        <main className=' relative'>
            ...
            <section className='px-32 h-fit py-16'>
                <div className='z-10'>
                ...
                <div className='grid grid-cols-12 gap-6 mt-6 z-10'>
                    <div className='col-span-5 p-6 border-solid border-2 border-cyan-1 relative bg-white'>
                    ...
                    <div className='col-span-6 p-6 border-solid border-2 border-cyan-1 relative bg-white'>
